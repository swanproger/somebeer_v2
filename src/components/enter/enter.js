    ...
    <>
      ...
      <div className="mainplace">
        <div className="regplace">
          ...
          <div className="descr">
            <p>
              Данный сайт является социальной сетью для beer - гиков. Тут вы
              можете оценивать испробованные сорта, посещённые пив-бары и
              пивоварни, общаться, делать посты, вести дневник попробованного
          ...
          <form className="form" onSubmit={handleSubmit}>
            <div
              ...
              style={{
                border:
                  enterError && !formData.Phonenumber ? "1px solid red" : null,
              }}
            >
